...
public class Chat {
    ...
    public Chat(int portNumber, Multihash targetAddress) throws IOException {
        ...
        embeddedIpfs = EmbeddedIpfs.build(recordStore, blockStore,
                ...
                bootstrapNodes,
                identitySection,
                authoriser, Optional.of(Chat.proxyHandler(proxyTargetAddress)));
        embeddedIpfs.start();
    ...
    public static void main(String[] args) throws IOException {
        ...
        Integer portNumber = Integer.parseInt("8123");//console.readLine().trim());
        System.out.println("Enter PeerId of other node");
        Multihash targetNodeId = Cid.decode("zdpuAwfJrGYtiGFDcSV3rDpaUrqCtQZRxMjdC6Eq9PNqLqTGg");//console.readLine().trim());
        new Chat(portNumber, targetNodeId);
    }
