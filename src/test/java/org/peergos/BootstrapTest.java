...
public class BootstrapTest {
    ...
    public void bootstrap() {
        ...
        Multihash kubo = Multihash.fromBase58("12D3KooWG3ZSzZmPiYsmWXQe8vngp5RPLxxgfXqGEuBkcVNc1x8t");

        try {
            List<MultiAddress> bootStrapNodes = List.of(
                    "/ip4/127.0.0.1/tcp/4001/p2p/" + kubo,
...
//                    "/dnsaddr/bootstrap.libp2p.io/p2p/QmQCU2EcMqAqQPR2i9bChDtGNJchTbq5TbXJJ16u19uLTa",
            ...
            int connections = dht.bootstrapRoutingTable(node1, bootStrapNodes);
            if (connections == 0)
