...
public class KademliaEngine {
    ...
    private static final java.util.logging.Logger LOG = org.peergos.util.Logging.LOG();
    ...
    public void receiveRequest(Dht.Message msg, PeerId source, Stream stream) {
        ...
        try {
            switch (msg.getType()) {
                ...
                case GET_VALUE: {
                    Multihash key = IPNS.getPublisherFromKey(msg.getKey());
            ...
            LOG.log(java.util.logging.Level.FINE,
                    "Failed to handle kademlia " + msg.getType() + " request: " + e.getMessage(), e);
        } finally {
            stream.close();
        }
    }
